...
(function (t, n) {
	...
	function l(t, n, e) {
		...
		if (n = +n, t = +t, e = +e, t === n && e > 0)
			return [t];
		if ((r = n < t) && (i = t, t = n, n = i), 0 === (a = h(t, n, e)) || !isFinite(a))
			return [];
		if (a > 0)
	...
	function h(t, n, e) {
		...
		o = r / Math.pow(10, i);
		return i >= 0 ? (o >= ns ? 10 : o >= es ? 5 : o >= rs ? 2 : 1) * Math.pow(10, i) : -Math.pow(10, -i) / (o >= ns ? 10 : o >= es ? 5 : o >= rs ? 2 : 1)
	}
	function d(t, n, e) {
		var r = Math.abs(n - t) / Math.max(0, e),
		i = Math.pow(10, Math.floor(Math.log(r) / Math.LN10)),
		o = r / i;
		return o >= ns ? i *= 10 : o >= es ? i *= 5 : o >= rs && (i *= 2),
		n < t ? -i : i
	}
	function p(t) {
	...
	function T(t, n) {
		function e(e) {
			...
			w = w.merge(T),
			N = N.merge(T.append("line").attr("stroke", "#000").attr(s + "2", c * a)),
			S = S.merge(T.append("text").attr("fill", "#000").attr(s, c * p).attr("dy", t === os ? "0em" : t === us ? "0.71em" : "0.32em")),
			e !== b && (m = m.transition(e), w = w.transition(e), N = N.transition(e), S = S.transition(e), M = M.transition(e).attr("opacity", cs).attr("transform", function (t) {
			...
			M.remove(),
			m.attr("d", t === fs || t == as ? "M" + c * u + "," + g + "H0.5V" + y + "H" + c * u : "M" + g + "," + c * u + "V0.5H" + y + "V" + c * u),
			w.attr("opacity", 1).attr("transform", function (t) {
				return l(_(t))
			}),
			N.attr(s + "2", c * a),
			S.attr(s, c * p).text(d),
			b.filter(A).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", t === as ? "start" : t === fs ? "end" : "middle"),
			b.each(function () {
				this.__axis = _
			})
		}
	...
	function C(t) {
		...
		return (n.local ? function (t) {
			...
			return function () {
				...
				e = this.namespaceURI;
				return e === ls && n.documentElement.namespaceURI === ls ? n.createElement(t) : n.createElementNS(e, t)
			}
		})(n)
	}
	function P() {}
	...
	function it(t, n, e) {
		var r = _s.hasOwnProperty(t.type) ? nt : et;
			...
			if (f)
				for (var s = 0, l = f.length; s < l; ++s)
					if ((u = f[s]).type === t.type && u.name === t.name)
						return this.removeEventListener(u.type, u.listener, u.capture), this.addEventListener(u.type, u.listener = c, u.capture = e), void(u.value = n);
	...
	function Ut(t, n, e, r) {
		return 1 === arguments.length ? function (t) {
			...
			u = o - i,
			f = (o + i) / 2;
			return u ? (a = n === o ? (e - r) / u + 6 * (e < r) : e === o ? (r - n) / u + 2 : (n - e) / u + 4, u /= f < .5 ? o + i : 2 - o - i, a *= 60) : u = f > 0 && f < 1 ? 0 : a,
			new qt(a, u, f, t.opacity)
		}
	...
	function Yt(t) {
		...
		a = It((.2126729 * e + .7151522 * r + .072175 * i) / Us);
		return new Ft(116 * a - 16, 500 * (o - a), 200 * (a - It((.0193339 * e + .119192 * r + .9503041 * i) / qs)), t.opacity)
	}
	function Bt(t, n, e, r) {
	...
	function $t(t, n, e, r) {
		return 1 === arguments.length ? function (t) {
			...
			f = u ? Math.atan2(a, o) * Ls - 120 : NaN;
			return new Wt(f < 0 ? f + 360 : f, u, i, t.opacity)
		}
	...
	function sn(t, n) {
		...
		u = [],
		f = [];
		for (t += "", n += ""; (e = rl.exec(t)) && (r = il.exec(n)); )
			(i = r.index) > o && (i = n.slice(o, i), u[a] ? u[a] += i : u[++a] = i), (e = e[0]) === (r = r[0]) ? u[a] ? u[a] += r : u[++a] = r : (u[++a] = null, f.push({
						i: a,
						x: fn(e, r)
					})), o = il.lastIndex;
		return o < n.length && (i = n.slice(o), u[a] ? u[a] += i : u[++a] = i),
		u.length < 2 ? f[0] ? function (t) {
			return function (n) {
				return t(n) + ""
			}
		}
	...
	function ln(t, n) {
		var e,
		r = typeof n;
		return null == n || "boolean" === r ? Kt(n) : ("number" === r ? fn : "string" === r ? (e = kt(n)) ? (n = e, tl) : sn : n instanceof kt ? tl : n instanceof Date ? un : Array.isArray(n) ? an : "function" != typeof n.valueOf && "function" != typeof n.toString || isNaN(n) ? cn : fn)(t, n)
	}
	function hn(t, n) {
		return t = +t,
		n -= t,
	...
	function dn(t, n, e, r, i, o) {
		...
		u,
		f;
		return (a = Math.sqrt(t * t + n * n)) && (t /= a, n /= a),
		(f = t * e + n * r) && (e -= t * f, r -= n * f),
		(u = Math.sqrt(e * e + r * r)) && (e /= u, r /= u, f /= u),
		t * r < n * e && (t = -t, n = -n, f = -f, a = -a), {
			translateX: i,
			translateY: o,
			rotate: Math.atan2(n, t) * ol,
			skewX: Math.atan(f) * ol,
			scaleX: a,
			scaleY: u
		}
	}
	...
	function gn(t, n) {
		...
		h = s * s + l * l;
		if (h < hl)
			r = Math.log(c / a) / cl, e = function (t) {
			...
			e = function (t) {
				...
				u = a / (sl * d) * (e * function (t) {
						...
						(g));
				return [i + u * s, o + u * l, a * e / vn(cl * n + g)]
			}
		}
	...
	function Sn(t) {
		if (!bl) {
			...
			t - Al > 24 ? (t < 1 / 0 && (ml = setTimeout(Tn, t - Nl.now() - Tl)), xl && (xl = clearInterval(xl))) : (xl || (Ml = Nl.now(), xl = setInterval(Nn, wl)), bl = 1, Sl(Tn))
		}
	}
	function En(t, n, e) {
		var r = new wn;
			...
			function r(f) {
				...
				for (c in u)
					if ((h = u[c]).name === e.name) {
						if (h.state === Rl)
							return En(r);
						h.state === Ll ? (h.state = Ul, h.timer.stop(), h.on.call("interrupt", t, t.__data__, h.index, h.group), delete u[c]) : +c < n && (h.state = Ul, h.timer.stop(), delete u[c])
					}
				if (En(function () {
	...
	function Dn(t, n) {
		var e;
		return ("number" == typeof n ? fn : n instanceof kt ? tl : (e = kt(n)) ? (n = e, tl) : sn)(t, n)
	}
	function Un(t, n, e, r) {
		this._groups = t,
		this._parents = n,
	...
	function te(n) {
		function e(t) {
			var e = t.property("__brush", u).selectAll(".overlay").data([Wn("overlay")]);
			e.enter().append("rect").attr("class", "overlay").attr("pointer-events", "all").attr("cursor", yh.overlay).merge(e).each(function () {
				var t = Jn(this).extent;
				ct(this).attr("x", t[0][0]).attr("y", t[0][1]).attr("width", t[1][0] - t[0][0]).attr("height", t[1][1] - t[0][1])
			}),
			t.selectAll(".selection").data([Wn("selection")]).enter().append("rect").attr("class", "selection").attr("cursor", yh.selection).attr("fill", "#777").attr("fill-opacity", .3).attr("stroke", "#fff").attr("shape-rendering", "crispEdges");
		...
		function a() {
			function e() {
				var t = pt(w);
				!L || m || x || (Math.abs(t[0] - U[0]) > Math.abs(t[1] - U[1]) ? x = !0 : m = !0),
				U = t,
				b = !0,
				$n(),
				o()
			...
			function o() {
				...
				case lh:
				case sh:
					T && (y = Math.max(C - u, Math.min(z - d, y)), c = u + y, p = d + y),
					N && (_ = Math.max(P - l, Math.min(R - v, _)), h = l + _, g = v + _);
					break;
				case hh:
					T < 0 ? (y = Math.max(C - u, Math.min(z - u, y)), c = u + y, p = d) : T > 0 && (y = Math.max(C - d, Math.min(z - d, y)), c = u, p = d + y),
					N < 0 ? (_ = Math.max(P - l, Math.min(R - l, _)), h = l + _, g = v) : N > 0 && (_ = Math.max(P - v, Math.min(R - v, _)), h = l, g = v + _);
					break;
				case dh:
					T && (c = Math.max(C, Math.min(z, u - y * T)), p = Math.max(C, Math.min(z, d + y * T))),
					N && (h = Math.max(P, Math.min(R, l - _ * N)), g = Math.max(P, Math.min(R, v + _ * N)))
				}
				p < c && (T *= -1, t = u, u = d, d = t, t = c, c = p, p = t, M in _h && Y.attr("cursor", yh[M = _h[M]])),
				g < h && (N *= -1, t = l, l = v, v = t, t = h, h = g, g = t, M in bh && Y.attr("cursor", yh[M = bh[M]])),
				S.selection && (k = S.selection),
				m && (c = k[0][0], p = k[1][0]),
				x && (h = k[0][1], g = k[1][1]),
				k[0][0] === c && k[0][1] === h && k[1][0] === p && k[1][1] === g || (S.selection = [[c, h], [p, g]], r.call(w), q.brush())
			}
			function a() {
				if (Vn(), t.event.touches) {
					...
					bt(t.event.view, b), B.on("keydown.brush keyup.brush mousemove.brush mouseup.brush", null);
				O.attr("pointer-events", "all"),
				Y.attr("cursor", yh.overlay),
				S.selection && (k = S.selection),
				Kn(k) && (S.selection = null, r.call(w)),
				q.end()
			}
			if (t.event.touches) {
			...
			if (s.apply(this, arguments)) {
				...
				"overlay" === M ? S.selection = k = [[u = n === vh ? C : D[0], l = n === ph ? P : D[1]], [d = n === vh ? z : u, v = n === ph ? R : l]] : (u = k[0][0], l = k[0][1], d = k[1][0], v = k[1][1]),
				c = u,
				h = l,
				p = d,
				g = v;
				var O = ct(w).attr("pointer-events", "none"),
				Y = O.selectAll(".overlay").attr("cursor", yh[M]);
				if (t.event.touches)
					O.on("touchmove.brush", e, !0).on("touchend.brush touchcancel.brush", a, !0);
				else {
					var B = ct(t.event.view).on("keydown.brush", function () {
							...
							case 16:
								...
								break;
							case 18:
								A === hh && (T && (d = p - y * T, u = c + y * T), N && (v = g - _ * N, l = h + _ * N), A = dh, o());
								break;
							case 32:
								A !== hh && A !== dh || (T < 0 ? d = p - y : T > 0 && (u = c - y), N < 0 ? v = g - _ : N > 0 && (l = h - _), A = lh, Y.attr("cursor", yh.selection), o());
								break;
							default:
								return
							}
							...
							case 16:
								...
								break;
							case 18:
								A === dh && (T < 0 ? d = p : T > 0 && (u = c), N < 0 ? v = g : N > 0 && (l = h), A = hh, o());
								break;
							case 32:
								A === lh && (t.event.altKey ? (T && (d = p - y * T, u = c + y * T), N && (v = g - _ * N, l = h + _ * N), A = dh) : (T < 0 ? d = p : T > 0 && (u = c), N < 0 ? v = g : N > 0 && (l = h), A = hh), Y.attr("cursor", yh[M]), o());
								break;
							default:
								return
							}
		...
		return e.move = function (t, e) {
			t.selection ? t.on("start.brush", function () {
				...
				Rn(this),
				o.selection = null == a || Kn(a) ? null : a,
				r.call(this),
				u.start().brush().end()
			})
		},
	...
	function xe() {
		...
		function r(t, n, e) {
			t.forEach(function (t) {
				...
				c = 0 | u,
				s = n[c * i + f];
				a > 0 && a < i && f === a && (r = n[c * i + f - 1], t[0] = a + (e - r) / (s - r) - .5),
				u > 0 && u < o && c === u && (r = n[(c - 1) * i + f], t[1] = u + (e - r) / (s - r) - .5)
			})
		}
		var i = 1,
		o = 1,
	...
	function Se(t) {
		function n(t, n) {
			function e() {
				...
				e,
				r = u;
				if (t.charCodeAt(r) === qh) {
					for (; u++ < a && t.charCodeAt(u) !== qh || t.charCodeAt(++u) === qh; );
					return (n = u) >= a ? c = !0 : (e = t.charCodeAt(u++)) === Oh ? s = !0 : e === Yh && (s = !0, t.charCodeAt(u) === Oh && ++u),
					t.slice(r + 1, n - 1).replace(/""/g, '"')
				}
				for (; u < a; ) {
					if ((e = t.charCodeAt(n = u++)) === Oh)
						s = !0;
					else if (e === Yh)
						s = !0, t.charCodeAt(u) === Oh && ++u;
					else if (e !== o)
						continue;
					return t.slice(r, n)
				}
			...
			c = a <= 0,
			s = !1;
			for (t.charCodeAt(a - 1) === Oh && --a, t.charCodeAt(a - 1) === Yh && --a; (r = e()) !== Uh; ) {
				for (var l = []; r !== Dh && r !== Uh; )
					l.push(r), r = e();
	...
	function qe(t, n, e, r) {
		...
		if (!d)
			return t._root = p, t;
		for (; d.length; )
			if ((c = n >= (o = (v + y) / 2)) ? v = o : y = o, (s = e >= (a = (g + _) / 2)) ? g = a : _ = a, i = d, !(d = d[l = s << 1 | c]))
				return i[l] = p, t;
		if (u = +t._x.call(null, d.data), f = +t._y.call(null, d.data), n === u && e === f)
	...
	function Fe(t, n, e) {
		var r = new Ie(null == n ? Ye : n, null == e ? Be : e, NaN, NaN, NaN, NaN);
		...
		function n(t) {
			function n(t) {
				...
				if ("c" === v)
					...
					var x = (t = +t) < 0;
					if (t = _(Math.abs(t), p), x && 0 == +t && (x = !1), s = (x ? "(" === c ? c : "-" : "-" === c || "(" === c ? "" : c) + s, m = ("s" === v ? fd[8 + ed / 3] : "") + m + (x && "(" === c ? ")" : ""), b)
						for (n = -1, r = t.length; ++n < r; )
							if (48 > (a = t.charCodeAt(n)) || a > 57) {
								m = (46 === a ? i + t.slice(n + 1) : t.slice(n)) + m,
								t = t.slice(0, n);
								break
							}
				}
				...
				switch (d && l && (t = e(M + t, M.length ? h - m.length : 1 / 0), M = ""), f) {
				case "<":
					t = s + t + m + M;
					break;
				case "=":
	...
	function rr(n) {
		return ud = er(n),
		t.format = ud.format,
		t.formatPrefix = ud.formatPrefix,
		ud
	}
	function ir(t) {
	...
	function Er(t) {
		var n = op(t[0] * t[0] + t[1] * t[1] + t[2] * t[2]);
		t[0] /= n,
		t[1] /= n,
		t[2] /= n
	}
	function kr(t, n) {
		wd.push(Md = [pd = t, gd = t]),
		n < vd && (vd = n),
		n > yd && (yd = n)
	}
	function Cr(t, n) {
		...
		if (xd) {
			...
			f = i[0] * Vd * u,
			c = Wd(a) > 180;
			c ^ (u * _d < f && f < u * t) ? (o = i[1] * Vd) > yd && (yd = o) : (f = (f + 360) % 360 - 180, c ^ (u * _d < f && f < u * t) ? (o = -i[1] * Vd) < vd && (vd = o) : (n < vd && (vd = n), n > yd && (yd = n))),
			c ? t < _d ? Ur(pd, t) > Ur(pd, gd) && (gd = t) : Ur(t, gd) > Ur(pd, gd) && (pd = t) : gd >= pd ? (t < pd && (pd = t), t > gd && (gd = t)) : t > _d ? Ur(pd, t) > Ur(pd, gd) && (gd = t) : Ur(t, gd) > Ur(pd, gd) && (pd = t)
		} else
			wd.push(Md = [pd = t, gd = t]);
		n < vd && (vd = n),
		n > yd && (yd = n),
	...
	function Rr(t, n) {
		if (xd) {
			var e = t - _d;
			hp.add(Wd(e) > 180 ? e + (e > 0 ? 360 : -360) : e)
		} else
			bd = t, md = n;
		lp.point(t, n),
		Cr(t, n)
	...
	function jr(t, n) {
		...
		i = e * rp(t),
		o = rp(n),
		a = Qd(op((a = Od * o - Yd * i) * a + (a = Yd * r - qd * o) * a + (a = qd * i - Od * r) * a), qd * r + Od * i + Yd * o);
		Td += a,
		kd += a * (qd + (qd = r)),
		Cd += a * (Od + (Od = i)),
		Pd += a * (Yd + (Yd = o)),
	...
	function Kr(t) {
		return function (n, e) {
			return n += t,
			[n > jd ? n - Gd : n < -jd ? n + Gd : n, e]
		}
	}
	function ti(t) {
		var n = Kr(t);
		return n.invert = Kr(-t),
		n
	}
	function ni(t, n) {
		function e(t, n) {
			...
			c = rp(n),
			s = c * r + u * i;
			return [Qd(f * o - s * a, u * r - c * i), lr(s * o + f * a)]
		}
		var r = Jd(t),
		i = rp(t),
		o = Jd(n),
		...
		return e.invert = function (t, n) {
			...
			c = rp(n),
			s = c * o - f * a;
			return [Qd(f * o + c * a, u * r + s * i), lr(s * r - u * i)]
		},
		e
	}
	function ei(t) {
		function n(n) {
			return n = t(n[0] * $d, n[1] * $d),
			n[0] *= Vd,
			n[1] *= Vd,
			n
		}
		return t = Jr(t[0] * $d, t[1] * $d, t.length > 2 ? t[2] * $d : 0),
		n.invert = function (n) {
			return n = t.invert(n[0] * $d, n[1] * $d),
			n[0] *= Vd,
			n[1] *= Vd,
			n
		},
	...
	function ri(t, n, e, r, i, o) {
		if (e) {
			...
			u = rp(n),
			f = r * e;
			null == i ? (i = n + r * Gd, o = n - f / 2) : (i = ii(a, i), o = ii(a, o), (r > 0 ? i < o : i > o) && (i += r * Gd));
				...
				if (!((n = t.length - 1) <= 0)) {
					...
					if (ai(r, a)) {
						for (i.lineStart(), o = 0; o < n; ++o)
							...
							u.push(e = new ui(r, t, null, !0)), f.push(e.o = new ui(r, null, e, !1)), u.push(e = new ui(a, t, null, !1)), f.push(e.o = new ui(a, null, e, !0))
					}
				}), u.length) {
	...
	function si(t, n) {
		...
		u = 0;
		Np.reset(),
		1 === i ? r = Hd + Fd : -1 === i && (r = -Hd - Fd);
		for (var f = 0, c = t.length; f < c; ++f)
			if (l = (s = t[f]).length)
				for (var s, l, h = s[l - 1], d = h[0], p = h[1] / 2 + Xd, v = rp(p), g = Jd(p), y = 0; y < l; ++y, d = b, v = x, g = w, h = _) {
					var _ = s[y],
					b = _[0],
					m = _[1] / 2 + Xd,
					x = rp(m),
					...
					N = T > jd,
					S = v * x;
					if (Np.add(Qd(S * A * rp(T), g * w + S * Jd(T))), a += N ? M + A * Gd : M, N ^ d >= e ^ b >= e) {
						var E = Tr(Mr(h), Mr(_));
						Er(E);
						var k = Tr(o, E);
						Er(k);
						var C = (N ^ M >= 0 ? -1 : 1) * lr(k[2]);
		...
		return function (i) {
			...
			function l() {
				...
				if (p.pop(), h.push(p), p = null, u)
					if (1 & o) {
						...
						u > 1 && 2 & o && a.push(a.pop().concat(a.shift())), d.push(a.filter(hi))
			}
			var h,
			d,
			p,
			...
			m = {
				...
				polygonEnd: function () {
					...
					d = y(d);
					var t = si(h, r);
					d.length ? (b || (i.polygonStart(), b = !0), fi(d, di, t, e, i)) : t && (b || (i.polygonStart(), b = !0), i.lineStart(), e(null, null, 1, i), i.lineEnd()),
					b && (i.polygonEnd(), b = !1),
					d = h = null
				},
				sphere: function () {
	...
	function pi(t) {
		...
		function e(t, n, e) {
			...
			if (!(g < 0)) {
				...
				var A = x - m,
				T = Wd(A - jd) < Fd;
				if (!T && M < w && (b = w, w = M, M = b), T || A < Fd ? T ? w + M > 0 ^ _[1] < (Wd(_[0] - m) < Fd ? w : M) : w <= _[1] && _[1] <= M : A > jd ^ (m <= _[0] && _[0] <= x)) {
					var N = Sr(d, (-p + y) / v);
					return Nr(N, h),
					[_, wr(N)]
				}
		...
		return li(n, function (t) {
			...
			return {
				...
				point: function (l, h) {
					...
					p = [l, h],
					v = n(l, h),
					g = a ? v ? 0 : r(l, h) : v ? r(l + (l < 0 ? jd : -jd), h) : 0;
					if (!i && (c = f = v) && t.lineStart(), v !== f && (!(d = e(i, p)) || ai(i, d) || ai(p, d)) && (p[0] += Fd, p[1] += Fd, v = n(p[0], p[1])), v !== f)
						s = 0, v ? (t.lineStart(), d = e(p, i), t.point(d[0], d[1])) : (d = e(i, p), t.point(d[0], d[1]), t.lineEnd()), i = d;
					else if (u && i && a ^ v) {
						var y;
	...
	function vi(t, n, e, r) {
		...
		return function (a) {
			...
			function c(o, a) {
				var u = i(o, a);
				if (l && h.push([o, a]), m)
					d = o, p = a, v = u, m = !1, u && (w.lineStart(), w.point(o, a));
				else if (u && b)
					w.point(o, a);
				else {
					var f = [g = Math.max(kp, Math.min(Ep, g)), _ = Math.max(kp, Math.min(Ep, _))],
					c = [o = Math.max(kp, Math.min(Ep, o)), a = Math.max(kp, Math.min(Ep, a))];
							...
							if (a = i - u, l || !(a < 0)) {
								...
								if (a = r - f, h || !(a > 0)) {
									...
									if (a = o - f, h || !(a < 0)) {
										...
										return c > 0 && (t[0] = u + c * l, t[1] = f + c * h),
			...
			A = {
				...
				polygonEnd: function () {
					...
					e = x && n,
					i = (s = y(s)).length;
					(e || i) && (a.polygonStart(), e && (a.lineStart(), o(null, null, 1, a), a.lineEnd()), i && fi(s, u, n, o, a), a.polygonEnd()),
					w = a,
					s = l = h = null
				}
			};
	...
	function Mi(t, n) {
		var e = mi(t[0], t[1]);
		return mi(t[0], n) + mi(n, t[1]) <= e + Fd
	}
	function Ai(t, n) {
		return !!si(t.map(Ti), Ni(n))
	}
	function Ti(t) {
		return (t = t.map(Ni)).pop(),
		t
	}
	function Ni(t) {
		return [t[0] * $d, t[1] * $d]
		...
		return +n ? function (t, n) {
			function e(r, i, o, a, u, f, c, s, l, h, d, p, v, g) {
				...
				if (b > 4 * n && v--) {
					...
					C = E - i,
					P = _ * k - y * C;
					(P * P / b > n || Wd((y * k + _ * C) / b - .5) > .3 || a * h + u * d + f * p < fv) && (e(r, i, o, a, u, f, S, E, T, m /= M, x /= M, w, v, g), g.point(S, E), e(S, E, T, m, x, w, c, s, l, h, d, p, v, g))
				}
			}
			return function (n) {
				function r(e, r) {
				...
				function o(r, i) {
					var o = Mr([r, i]),
					a = t(r, i);
					e(y, _, g, b, m, x, y = a[0], _ = a[1], g = r, b = o[0], m = o[1], x = o[2], uv, n),
					n.point(y, _)
				}
				function a() {
					w.point = r,
				...
				function c() {
					e(y, _, g, b, m, x, l, h, s, d, p, v, uv, n),
					w.lineEnd = a,
					a()
				}
				var s,
	...
	function uo(t, n) {
		function e(t, n) {
			var e = op(o - 2 * i * rp(n)) / i;
			return [e * rp(t *= i), a - e * Jd(t)]
		}
		var r = rp(t),
		i = (r + rp(n)) / 2;
		if (Wd(i) < Fd)
		...
		return e.invert = function (t, n) {
			var e = a - n;
			return [Qd(t, Wd(e)) / i * ip(e), lr((o - (t * t + e * e) * i * i) / (2 * i))]
		},
		e
	}
	function fo() {
	...
	function po(t) {
		function n() {
			var n = jd * u(),
			a = o(ei(o.rotate()).invert([0, 0]));
			return c(null == s ? [[a[0] - n, a[1] - n], [a[0] + n, a[1] + n]] : t === ho ? [[Math.max(a[0] - n, s), e], [Math.min(a[0] + n, r), i]] : [[s, Math.max(a[1] - n, e)], [r, Math.min(a[1] + n, i)]])
		}
		var e,
		r,
		i,
	...
	function go(t, n) {
		function e(t, n) {
			o > 0 ? n < -Hd + Fd && (n = -Hd + Fd) : n > Hd - Fd && (n = Hd - Fd);
			var e = o / ep(vo(n), i);
			return [e * rp(i * t), o - e * Jd(i * t)]
		}
		var r = Jd(t),
		...
		return i ? (e.invert = function (t, n) {
			var e = o - n,
			r = ip(i) * op(t * t + e * e);
			return [Qd(t, Wd(e)) / i * ip(e), 2 * Zd(ep(o / r, 1 / i)) - Hd]
		}, e) : ho
	}
	function yo(t, n) {
		return [t, n]
	...
	function _o(t, n) {
		function e(t, n) {
			var e = o - n,
			r = i * t;
			return [e * rp(r), o - e * Jd(r)]
		}
		var r = Jd(t),
		i = t === n ? rp(t) : (r - Jd(n)) / (n - t),
		o = r / i + t;
		return Wd(i) < Fd ? yo : (e.invert = function (t, n) {
			var e = o - n;
			return [Qd(t, Wd(e)) / i * ip(e), o - ip(i) * op(t * t + e * e)]
		}, e)
	}
	function bo(t, n) {
		var e = Jd(n),
		r = Jd(t) * e;
		return [e * rp(t) / r, rp(n) / r]
	}
	function mo(t, n, e, r) {
		return 1 === t && 1 === n && 0 === e && 0 === r ? Ci : Wi({
			point: function (i, o) {
			...
			n = t[r], e && Uo(e, n) ? ++r : (e = function (t) {
				...
				(o = function (t, n) {
					...
					for (e = 0; e < t.length; ++e)
						if (Do(n, t[e]) && qo(Oo(t[e], n), t))
							return [t[e], n];
					for (e = 0; e < t.length - 1; ++e)
						for (r = e + 1; r < t.length; ++r)
							if (Do(Oo(t[e], t[r]), n) && Do(Oo(t[e], n), t[r]) && Do(Oo(t[r], n), t[e]) && qo(Yo(t[e], t[r], n), t))
								return [t[e], t[r], n];
					throw new Error
				}
					(o, n)), r = 0);
	...
	function Ho(t) {
		...
		t: for (u = 3; u < i; ++u) {
			...
			for (r.previous = n, r.next = e, n.next = e.previous = e = r, o = Io(n); (r = r.next) !== e; )
				(a = Io(r)) < o && (n = r, o = a);
			e = n.next
		}
	...
	function ca(t, n, e, r, i, o) {
		for (var a, u, f, c, s, l, h, d, p, v, g, y = [], _ = n.children, b = 0, m = 0, x = _.length, w = n.value; b < x; ) {
			...
			a.dice ? Ko(a, e, r, i, w ? r += c * s / w : o) : fa(a, e, r, w ? e += f * s / w : i, o),
			w -= s,
			b = m
		}
		return y
	...
	function Ma(t, n) {
		function e() {
			return i = Math.min(u.length, f.length) > 2 ? xa : ma,
			o = a = null,
			r
		}
		function r(n) {
	...
	function Aa(n) {
		...
		n.tickFormat = function (n, r) {
			return function (n, e, r) {
				...
				a = n[n.length - 1],
				u = d(o, a, null == e ? 10 : e);
				switch ((r = Ke(null == r ? ",f" : r)).type) {
				case "s":
					var f = Math.max(Math.abs(o), Math.abs(a));
					return null != r.precision || isNaN(i = or(u, f)) || (r.precision = i),
					t.formatPrefix(r, f);
				case "":
				case "e":
				case "g":
				case "p":
				case "r":
					null != r.precision || isNaN(i = ar(u, Math.max(Math.abs(o), Math.abs(a)))) || (r.precision = i - ("e" === r.type));
					break;
				case "f":
				case "%":
					null != r.precision || isNaN(i = ir(u)) || (r.precision = i - 2 * ("%" === r.type))
				}
				return t.format(r)
			}
			(e(), n, r)
		...
		n.nice = function (t) {
			...
			u = i[o],
			f = i[a];
			return f < u && (r = u, u = f, f = r, r = o, o = a, a = r),
			(r = h(u, f, t)) > 0 ? r = h(u = Math.floor(u / r) * r, f = Math.ceil(f / r) * r, t) : r < 0 && (r = h(u = Math.ceil(u * r) / r, f = Math.floor(f * r) / r, t)),
			r > 0 ? (i[o] = Math.floor(u / r) * r, i[a] = Math.ceil(f / r) * r, e(i)) : r < 0 && (i[o] = Math.ceil(u * r) / r, i[a] = Math.floor(f * r) / r, e(i)),
			n
		},
		n
	}
	...
	function Sa(t, n) {
		...
		o = t[r],
		a = t[i];
		return a < o && (e = r, r = i, i = e, e = o, o = a, a = e),
		t[r] = n.floor(o),
		t[i] = n.ceil(a),
		t
	}
			...
			return function (e) {
				...
				if ("p" in a && (a.H = a.H % 12 + 12 * a.p), "V" in a) {
					if (a.V < 1 || a.V > 53)
						return null;
					"w" in a || (a.w = 1),
					"Z" in a ? (i = (o = (i = Ha(Xa(a.y))).getUTCDay()) > 4 || 0 === o ? vg.ceil(i) : vg(i), i = hg.offset(i, 7 * (a.V - 1)), a.y = i.getUTCFullYear(), a.m = i.getUTCMonth(), a.d = i.getUTCDate() + (a.w + 6) % 7) : (i = (o = (i = n(Xa(a.y))).getDay()) > 4 || 0 === o ? Xv.ceil(i) : Xv(i), i = Iv.offset(i, 7 * (a.V - 1)), a.y = i.getFullYear(), a.m = i.getMonth(), a.d = i.getDate() + (a.w + 6) % 7)
				} else ("W" in a || "U" in a) && ("w" in a || (a.w = "u" in a ? a.u % 7 : "W" in a ? 1 : 0), o = "Z" in a ? Ha(Xa(a.y)).getUTCDay() : n(Xa(a.y)).getDay(), a.m = 0, a.d = "W" in a ? (a.w + 6) % 7 + 7 * a.W - (o + 5) % 7 : a.w + 7 * a.U - (o + 6) % 7);
				return "Z" in a ? (a.H += a.Z / 100 | 0, a.M += a.Z % 100, Ha(a)) : n(a)
			}
		}
		function r(t, n, e, r) {
			for (var i, o, a = 0, u = n.length, f = e.length; a < u; ) {
				...
				if (37 === (i = n.charCodeAt(a++))) {
					if (i = n.charAt(a++), !(o = A[i in Rg ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0)
						return -1
	...
	function Su(t, n) {
		var e = t.getDay();
		return t = e >= 4 || 0 === e ? $v(t) : $v.ceil(t),
		Va($v.count(ag(t), t) + (4 === ag(t).getDay()), n, 2)
	}
	function Eu(t) {
		return t.getDay()
	}
	...
	function zu(t) {
		...
		return (n > 0 ? "-" : (n *= -1, "+")) + Va(n / 60 | 0, "0", 2) + Va(n % 60, "0", 2)
	}
	function Ru(t, n) {
	...
	function Hu(t, n) {
		var e = t.getUTCDay();
		return t = e >= 4 || 0 === e ? _g(t) : _g.ceil(t),
		Va(_g.count(Cg(t), t) + (4 === Cg(t).getUTCDay()), n, 2)
	}
	function Xu(t) {
		return t.getUTCDay()
	}
	...
	function Ku(n) {
		return Pg = Ga(n),
		t.timeFormat = Pg.format,
		t.timeParse = Pg.parse,
		t.utcFormat = Pg.utcFormat,
		t.utcParse = Pg.utcParse,
		Pg
	}
	function tf(t) {
		return new Date(t)
	...
	function ef(t, n, r, i, o, a, u, f, c) {
		...
		function l(n, r, i, o) {
			if (null == n && (n = 10), "number" == typeof n) {
				...
				u === A.length ? (o = d(r / Gg, i / Gg, n), n = t) : u ? (o = (u = A[a / A[u - 1][2] < A[u][2] / a ? u - 1 : u])[1], n = u[0]) : (o = Math.max(d(r, i, n), 1), n = f)
			}
		...
		w = c("%B"),
		M = c("%Y"),
		A = [[u, 1, Bg], [u, 5, 5 * Bg], [u, 15, 15 * Bg], [u, 30, 30 * Bg], [a, 1, Fg], [a, 5, 5 * Fg], [a, 15, 15 * Fg], [a, 30, 30 * Fg], [o, 1, Ig], [o, 3, 3 * Ig], [o, 6, 6 * Ig], [o, 12, 12 * Ig], [i, 1, jg], [i, 2, 2 * jg], [r, 1, Hg], [n, 1, Xg], [n, 3, 3 * Xg], [t, 1, Gg]];
		...
		h.nice = function (t, n) {
			var e = v();
			return (t = l(t, e[0], e[e.length - 1], n)) ? v(Sa(e, t)) : h
		},
		h.copy = function () {
	...
	function xf() {
		function t(t) {
			...
			g = new Array(p),
			y = new Array(p);
			for (null == u && (c = f(d = re())), n = 0; n <= p; ++n) {
				if (!(n < p && a(h = t[n], n, t)) === v)
					if (v = !v)
						s = n, c.areaStart(), c.lineStart();
					else {
	...
	function zf(t) {
		function n() {
			...
			f = e.apply(this, u),
			c = r.apply(this, u);
			if (a || (a = n = re()), t(a, +i.apply(this, (u[0] = f, u)), +o.apply(this, u), +i.apply(this, (u[0] = c, u)), +o.apply(this, u)), n)
	...
	function Jf(t, n, e) {
		...
		a = (e - t._y1) / (i || r < 0 && -0),
		u = (o * i + a * r) / (r + i);
		return (Qf(o) + Qf(a)) * Math.min(Math.abs(o), Math.abs(a), .5 * Math.abs(u)) || 0
	}
	function Kf(t, n) {
		var e = t._x1 - t._x0;
	...
	function mc(t, n, e, r) {
		...
		e && wc(i, t, n, e),
		r && wc(i, n, t, r),
		W_[t.index].halfedges.push(o),
		W_[n.index].halfedges.push(o),
		i
	}
	function xc(t, n, e) {
		var r = [n, e];
	...
	function kc(t) {
		var n = t.circle;
		n && (n.P || (V_ = n.N), Z_.remove(n), J_.push(n), gc(n), t.circle = null)
	}
	function Cc(t) {
	...
	function zc(t) {
		...
		u = [t];
		Pc(t);
		for (var f = o; f.circle && Math.abs(e - f.circle.x) < tb && Math.abs(r - f.circle.cy) < tb; )
			o = f.P, u.unshift(f), Pc(f), f = o;
		u.unshift(f),
		kc(f);
		for (var c = a; c.circle && Math.abs(e - c.circle.x) < tb && Math.abs(r - c.circle.cy) < tb; )
	...
	function Rc(t) {
			...
			if ((r = Lc(u, a) - o) > tb)
				...
				if (!((i = o - function (t, n) {
							...
							if (e)
								...
								(u, a)) > tb)) {
						r > -tb ? (n = u.P, e = u) : i > -tb ? (n = u, e = u.N) : n = e = u;
						break
					}
				if (!u.R) {
					n = u;
		...
		if ($_.insert(n, f), n || e) {
			if (n === e)
				return kc(n), e = Cc(n.site), $_.insert(f, e), f.edge = e.edge = mc(n.site, f.site), Ec(n), void Ec(e);
			if (e) {
				kc(n),
				kc(e);
				var c = n.site,
	...
	function qc(t, n) {
		...
		i,
		o = t.sort(Uc).pop();
		for (Q_ = [], W_ = new Array(t.length), $_ = new vc, Z_ = new vc; ; )
			if (i = V_, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x))
				o[0] === e && o[1] === r || (Rc(o), e = o[0], r = o[1]), o = t.pop();
			else {
				if (!i)
					break;
				zc(i.arc)
			...
			function (t, n, e, r) {
				...
				if (y) {
					...
					if (y) {
						...
						A = [e, r],
						T = [e, n];
						y.halfedges.push(Q_.push(xc(a = y.site, w, M)) - 1, Q_.push(xc(a, M, A)) - 1, Q_.push(xc(a, A, T)) - 1, Q_.push(xc(a, T, w)) - 1)
					}
				}
				for (i = 0; i < g; ++i)
	...
	if ("undefined" != typeof document) {
		var ps = document.documentElement;
		if (!ps.matches) {
			var vs = ps.webkitMatchesSelector || ps.msMatchesSelector || ps.mozMatchesSelector || ps.oMatchesSelector;
			ds = function (t) {
				return function () {
	...
	if (t.event = null, "undefined" != typeof document) {
		"onmouseenter" in document.documentElement || (_s = {
	...
	ut.prototype = ft.prototype = {
		...
		data: function (t, n) {
			if (!t)
				return d = new Array(this.size()), c = -1, this.each(function (t) {
					d[++c] = t
				}), d;
			var e = n ? O : q,
			r = this._parents,
	...
	Nt(qt, Ut, St(Et, {
			...
			rgb: function () {
				...
				r = e + (e < .5 ? e : 1 - e) * n,
				i = 2 * e - r;
				return new Lt(Ot(t >= 240 ? t - 240 : t + 120, i, r), Ot(t, i, r), Ot(t < 120 ? t + 240 : t - 120, i, r), this.opacity)
			},
			displayable: function () {
	...
	Nt(Ft, Bt, St(Et, {
			...
			rgb: function () {
				...
				n = Ds * jt(n),
				e = qs * jt(e),
				new Lt(Ht(3.2404542 * n - 1.5371385 * t - .4985314 * e), Ht( - .969266 * n + 1.8760108 * t + .041556 * e), Ht(.0556434 * n - .2040259 * t + 1.0572252 * e), this.opacity)
			}
		})),
	Nt(Vt, Gt, St(Et, {
			brighter: function (t) {
	...
	Nt(Wt, $t, St(Et, {
			...
			rgb: function () {
				...
				r = Math.cos(t),
				i = Math.sin(t);
				return new Lt(255 * (n + e * ( - .14861 * r + 1.78277 * i)), 255 * (n + e * (Is * r + js * i)), 255 * (n + e * (Hs * r)), this.opacity)
			}
		}));
	var $s,
	Ws,
	...
	wn.prototype = Mn.prototype = {
		...
		restart: function (t, n, e) {
			...
			this._next || Ks === this || (Ks ? Ks._next = this : Js = this, Ks = this),
			this._call = t,
			this._time = e,
			Sn()
		},
		...
		style: function (t, n, e) {
			...
			return null == n ? this.styleTween(t, function (t, n) {
				...
				return function () {
					var a = F(this, t),
					u = e(this);
					return null == u && (this.style.removeProperty(t), u = F(this, t)),
	...
	oh = function t(n, e) {
		...
		var i = Math.asin(1 / (n = Math.max(1, n))) * (e /= ih);
	...
	ft.prototype.transition = function (t) {
		var n,
		e;
		t instanceof Un ? (n = t._id, t = t._name) : (n = On(), (e = fh).time = mn(), t = null == t ? null : t + "");
	...
	ee.prototype = re.prototype = {
		...
		arcTo: function (t, n, e, r, i) {
			...
			if (null === this._x1)
				...
				if (Math.abs(s * u - f * c) > 1e-6 && i) {
					...
					b = _ / y,
					m = _ / g;
					Math.abs(b - 1) > 1e-6 && (this._ += "L" + (t + b * c) + "," + (n + b * s)),
					this._ += "A" + i + "," + i + ",0,0," +  + (s * h > c * d) + "," + (this._x1 = t + m * u) + "," + (this._y1 = n + m * f)
				} else
					this._ += "L" + (this._x1 = t) + "," + (this._y1 = n);
			else ;
		},
		arc: function (t, n, e, r, i, o) {
			...
			e && (l < 0 && (l = l % Ch + Ch), l > Ph ? this._ += "A" + e + "," + e + ",0,1," + s + "," + (t - a) + "," + (n - u) + "A" + e + "," + e + ",0,1," + s + "," + (this._x1 = f) + "," + (this._y1 = c) : l > 1e-6 && (this._ += "A" + e + "," + e + ",0," +  + (l >= kh) + "," + s + "," + (this._x1 = t + e * Math.cos(i)) + "," + (this._y1 = n + e * Math.sin(i))))
		},
	...
	nd.find = function (t, n, e) {
		...
		p = [],
		v = this._root;
		for (v && p.push(new Oe(v, s, l, h, d)), null == e ? e = 1 / 0 : (s = t - e, l = n - e, h = t + e, d = n + e, e *= e); f = p.pop(); )
			if (!(!(v = f.node) || (i = f.x0) > h || (o = f.y0) > d || (a = f.x1) < s || (u = f.y1) < l))
				if (v.length) {
					var g = (i + a) / 2,
					y = (o + u) / 2;
					p.push(new Oe(v[3], g, y, a, u), new Oe(v[2], i, y, g, u), new Oe(v[1], g, o, a, y), new Oe(v[0], i, o, g, y)),
					(c = (n >= y) << 1 | t >= g) && (f = p[p.length - 1], p[p.length - 1] = p[p.length - 1 - c], p[p.length - 1 - c] = f)
				} else {
	...
	nd.remove = function (t) {
		...
		if (d.length)
			for (; ; ) {
				if ((c = o >= (u = (p + g) / 2)) ? p = u : g = u, (s = a >= (f = (v + y) / 2)) ? v = f : y = f, n = d, !(d = d[l = s << 1 | c]))
					return this;
				if (!d.length)
					break;
	...
	nd.visit = function (t) {
		...
		u = [],
		f = this._root;
		for (f && u.push(new Oe(f, this._x0, this._y0, this._x1, this._y1)); n = u.pop(); )
			if (!t(f = n.node, r = n.x0, i = n.y0, o = n.x1, a = n.y1) && f.length) {
				var c = (r + o) / 2,
				s = (i + a) / 2;
				(e = f[3]) && u.push(new Oe(e, c, s, o, a)),
				(e = f[2]) && u.push(new Oe(e, r, s, c, a)),
				(e = f[1]) && u.push(new Oe(e, c, i, o, s)),
				(e = f[0]) && u.push(new Oe(e, r, i, c, s))
			}
		return this
	},
	nd.visitAfter = function (t) {
		...
		e = [],
		r = [];
		for (this._root && e.push(new Oe(this._root, this._x0, this._y0, this._x1, this._y1)); n = e.pop(); ) {
			var i = n.node;
			if (i.length) {
				var o,
				a = n.x0,
				...
				s = (a + f) / 2,
				l = (u + c) / 2;
				(o = i[0]) && e.push(new Oe(o, a, u, s, l)),
				(o = i[1]) && e.push(new Oe(o, s, u, f, l)),
				(o = i[2]) && e.push(new Oe(o, a, l, s, c)),
				(o = i[3]) && e.push(new Oe(o, s, l, f, c))
			}
			r.push(n)
		}
		for (; n = r.pop(); )
	...
	od = {
		...
		s: function (t, n) {
			...
			a = r.length;
			return o === a ? r : o > a ? r + new Array(o - a + 1).join("0") : o > 0 ? r.slice(0, o) + "." + r.slice(o) : "0." + new Array(1 - o).join("0") + Ze(t, Math.max(0, n + o - 1))[0]
		},
		X: function (t) {
	...
	fr.prototype = {
		...
		add: function (t) {
			cr(Bd, t, this.t),
			cr(this, Bd.s, this.s),
			this.s ? this.t += Bd.t : this.s = Bd.t
		},
		valueOf: function () {
			return this.s
		}
	...
	lp = {
		...
		polygonEnd: function () {
			var t = +cp;
			sp.add(t < 0 ? Gd + t : t),
			this.lineStart = this.lineEnd = this.point = dr
		},
		sphere: function () {
			sp.add(Gd)
		}
	...
	dp = {
		...
		polygonEnd: function () {
			...
			dp.lineStart = Pr,
			dp.lineEnd = zr,
			cp < 0 ? (pd =  - (gd = 180), vd =  - (yd = 90)) : hp > Fd ? yd = 90 : hp < -Fd && (vd = -90),
			Md[0] = pd,
			Md[1] = gd
		}
	},
	...
	Sp = li(function () {
			...
			return {
				...
				point: function (o, a) {
					var u = o > 0 ? jd : -jd,
					f = Wd(o - e);
					Wd(f - jd) < Fd ? (t.point(e, r = (r + a) / 2 > 0 ? Hd : -Hd), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(u, r), t.point(o, r), n = 0) : i !== u && f >= jd && (Wd(e - i) < Fd && (e -= i * Fd), Wd(o - u) < Fd && (o -= u * Fd), r = function (t, n, e, r) {
						var i,
						o,
						a = rp(t - e);
						return Wd(a) > Fd ? Zd((rp(n) * (o = Jd(r)) * rp(e) - rp(r) * (i = Jd(n)) * rp(t)) / (i * o * a)) : (n + r) / 2
					}
						(e, r, o, a), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(u, r), n = 0),
					t.point(e = o, r = a),
					i = u
				},
				lineEnd: function () {
			...
			var i;
			if (null == t)
				i = e * Hd, r.point(-jd, i), r.point(0, i), r.point(jd, i), r.point(jd, 0), r.point(jd, -i), r.point(0, -i), r.point(-jd, -i), r.point(-jd, 0), r.point(-jd, i);
			else if (Wd(t[0] - n[0]) > Fd) {
				var o = t[0] < n[0] ? jd : -jd;
				i = e * o / 2,
				r.point(-o, i),
				r.point(0, i),
	...
	Op = {
		...
		polygonEnd: function () {
			Op.lineStart = Op.lineEnd = Op.point = dr,
			Up.add(Wd(qp)),
			qp.reset()
		},
		result: function () {
	...
	Kp = {
		...
		result: function () {
			var t = Jp ? [Zp / Jp, Qp / Jp] : Wp ? [Vp / Wp, $p / Wp] : Gp ? [Hp / Gp, Xp / Gp] : [NaN, NaN];
			return Hp = Xp = Gp = Vp = $p = Wp = Zp = Qp = Jp = 0,
			t
		}
	};
	Hi.prototype = {
		...
		point: function (t, n) {
			...
			default:
				...
				this._context.arc(t, n, this._radius, 0, Gd)
			}
		},
		result: dr
	};
	...
	wo.invert = lo(lr),
	Mo.invert = lo(function (t) {
			return 2 * Zd(t)
		}),
	Ao.invert = function (t, n) {
		return [-n, 2 * Zd(tp(t)) - Hd]
	},
	Ro.prototype = ko.prototype = {
		constructor: Ro,
		count: function () {
	...
	vv = {};
	ua.prototype = Object.create(Ro.prototype);
	var gv = (1 + Math.sqrt(5)) / 2,
	yv = function t(n) {
			...
			if ((a = t._squarify) && a.ratio === n)
				for (var a, u, f, c, s, l = -1, h = a.length, d = t.value; ++l < h; ) {
					for (f = (u = a[l]).children, c = u.value = 0, s = f.length; c < s; ++c)
						u.value += f[c].value;
					u.dice ? Ko(u, e, r, i, r += (o - r) * u.value / d) : fa(u, e, r, e += (i - e) * u.value / d, o),
					d -= u.value
				}
			else
				t._squarify = a = ca(n, t, e, r, i, o), a.ratio = n
		}
		return e.ratio = function (n) {
			return t((n = +n) > 1 ? n : 1)
		},
	...
	zv.every = function (t) {
		return t = Math.floor(t),
		isFinite(t) && t > 0 ? t > 1 ? Ba(function (n) {
	...
	Yv = Ov.range,
	Bv = Ba(function (t) {
			var n = t.getTimezoneOffset() * Lv % 36e5;
			n < 0 && (n += 36e5),
	...
	O_ = {
		draw: function (t, n) {
			...
			t.lineTo(o, a),
			t.lineTo(u, f),
			t.lineTo( - .5 * r - D_ * i, D_ * r +  - .5 * i),
			t.lineTo( - .5 * o - D_ * a, D_ * o +  - .5 * a),
			t.lineTo( - .5 * u - D_ * f, D_ * u +  - .5 * f),
			t.lineTo( - .5 * r + D_ * i,  - .5 * i - D_ * r),
			t.lineTo( - .5 * o + D_ * a,  - .5 * a - D_ * o),
			t.lineTo( - .5 * u + D_ * f,  - .5 * f - D_ * u),
			t.closePath()
		}
	},
	Y_ = [M_, A_, S_, z_, P_, L_, O_];
	Of.prototype = {
		areaStart: function () {
			this._line = 0
		},
	...
	Ff.prototype = {
		...
		lineEnd: function () {
			...
			e = t.length - 1;
			if (e > 0)
				for (var r, i = t[0], o = n[0], a = t[e] - i, u = n[e] - o, f = -1; ++f <= e; )
	...
	nc.prototype = {
		...
		lineEnd: function () {
			...
			case 2:
				...
				break;
			case 3:
				tc(this, this._t0, Kf(this, this._t0))
			}
			(this._line || 0 !== this._line && 1 === this._point) && this._context.closePath(),
			this._line = 1 - this._line
		},
		point: function (t, n) {
			...
			if (t = +t, n = +n, t !== this._x1 || n !== this._y1) {
				...
				case 2:
					this._point = 3,
					tc(this, Kf(this, e = Jf(this, t, n)), e);
					break;
				default:
					tc(this, this._t0, e = Jf(this, t, n))
				}
				this._x0 = this._x1,
				this._x1 = t,
				this._y0 = this._y1,
		...
		lineEnd: function () {
			...
			if (e)
				if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e)
					...
					for (var r = oc(t), i = oc(n), o = 0, a = 1; a < e; ++o, ++a)
	...
	vc.prototype = {
		...
		insert: function (t, n) {
			...
			if (t) {
				...
				this._ ? (t = bc(this._), n.P = null, n.N = t, t.P = t.L = n, e = t) : (n.P = n.N = null, this._ = n, e = null);
		...
		remove: function (t) {
			...
			o = t.L,
			a = t.R;
			if (e = o ? a ? bc(a) : o : a, i ? i.L === t ? i.L = e : i.R = e : this._ = e, o && a ? (r = e.C, e.C = t.C, e.L = o, o.U = e, e !== a ? (i = e.U, e.U = t.U, t = e.R, i.L = t, e.R = a, a.U = e) : (e.U = i, i = e, t = e.R)) : (r = t.C, t = e), t && (t.U = i), !r)
				if (t && t.C)
					t.C = !1;
				else {
					do {
						...
						if (t === i.L) {
							if ((n = i.R).C && (n.C = !1, i.C = !0, yc(this, i), n = i.R), n.L && n.L.C || n.R && n.R.C) {
								n.R && n.R.C || (n.L.C = !1, n.C = !0, _c(this, n), n = i.R),
								n.C = i.C,
								i.C = n.R.C = !1,
								yc(this, i),
								t = this._;
							...
							n.L && n.L.C || (n.R.C = !1, n.C = !0, yc(this, n), n = i.L),
							n.C = i.C,
							i.C = n.L.C = !1,
							_c(this, i),
							t = this._;
		...
		triangles: function () {
			...
			return this.cells.forEach(function (e, r) {
				if (o = (i = e.halfedges).length)
					for (var i, o, a, u = e.site, f = -1, c = n[i[o - 1]], s = c.left === u ? c.right : c.left; ++f < o; )
	...
	t.pairs = function (t, n) {
		null == n && (n = r);
		for (var e = 0, i = t.length - 1, o = t[0], a = new Array(i < 0 ? 0 : i); e < i; )
			a[e] = n(o, o = t[++e]);
		return a
	},
	...
	t.ribbon = function () {
		function t() {
			...
			g = i.apply(this, u) - Th,
			y = o.apply(this, u) - Th;
			if (a || (a = t = re()), a.moveTo(d, p), a.arc(0, 0, s, l, h), l === g && h === y || (a.quadraticCurveTo(0, 0, v * wh(g), v * Mh(g)), a.arc(0, 0, v, g, y)), a.quadraticCurveTo(0, 0, d, p), a.closePath(), t)
	...
	t.nest = function () {
		function t(n, i, a, u) {
			...
			for (var f, c, s, l = -1, h = n.length, d = o[i++], p = se(), v = a(); ++l < h; )
	...
	t.contourDensity = function () {
		...
		t.cellSize = function (t) {
			...
			return h = Math.floor(Math.log(t) / Math.LN2),
			o()
		},
		t.thresholds = function (n) {
		...
		t.bandwidth = function (t) {
			...
			return l = Math.round((Math.sqrt(4 * t * t + 1) - 1) / 2),
			o()
		},
		t
	},
	...
	t.forceCollide = function (t) {
			...
			for (var t, n, r, f, c, s, l, h = i.length, d = 0; d < u; ++d)
				for (n = Fe(i, He, Xe).visitAfter(e), t = 0; t < h; ++t)
					r = i[t], s = o[r.index], l = s * s, f = r.x + r.vx, c = r.y + r.vy, n.visit(function (t, n, e, i, o) {
						...
						d = s + h;
						if (!u)
							return n > f + d || i < f - d || e > c + d || o < c - d;
						if (u.index > r.index) {
							var p = f - u.x - u.vx,
							v = c - u.y - u.vy,
							g = p * p + v * v;
							g < d * d && (0 === p && (p = Ue(), g += p * p), 0 === v && (v = Ue(), g += v * v), g = (d - (g = Math.sqrt(g))) / g * a, r.vx += (p *= g) * (d = (h *= h) / (l + h)), r.vy += (v *= g) * d, u.vx -= p * (d = 1 - d), u.vy -= v * d)
						}
					})
		}
		function e(t) {
		...
		a = 1,
		u = 1;
		return "function" != typeof t && (t = De(null == t ? 1 : +t)),
		...
		function e() {
			if (u) {
				...
				for (n = 0, f = new Array(l); n < h; ++n)
					(e = t[n]).index = n, "object" != typeof e.source && (e.source = Ve(d, e.source)), "object" != typeof e.target && (e.target = Ve(d, e.target)), f[e.source.index] = (f[e.source.index] || 0) + 1, f[e.target.index] = (f[e.target.index] || 0) + 1;
	...
	t.forceManyBody = function () {
		...
		function r(t, n, e, r) {
			...
			d = i * i + f * f;
			if (h * h / l < d)
				return d < s && (0 === i && (i = Ue(), d += i * i), 0 === f && (f = Ue(), d += f * f), d < c && (d = Math.sqrt(c * d)), o.vx += i * t.value * a / d, o.vy += f * t.value * a / d), !0;
			if (!(t.length || d >= s)) {
				(t.data !== o || t.next) && (0 === i && (i = Ue(), d += i * i), 0 === f && (f = Ue(), d += f * f), d < c && (d = Math.sqrt(c * d)));
				do {
	...
	t.forceRadial = function (t, n, e) {
		...
		u,
		f = De(.1);
		return "function" != typeof t && (t = De(+t)),
		null == n && (n = 0),
		null == e && (e = 0),
	...
	t.forceX = function (t) {
		...
		o,
		a = De(.1);
		return "function" != typeof t && (t = De(null == t ? 0 : +t)),
		n.initialize = function (t) {
			r = t,
			e()
		},
	...
	t.formatDefaultLocale = rr,
	t.formatLocale = er,
	t.formatSpecifier = Ke,
	t.precisionFixed = ir,
	t.precisionPrefix = or,
	t.precisionRound = ar,
	...
	t.geoBounds = function (t) {
		...
		a,
		u;
		if (yd = gd =  - (pd = vd = 1 / 0), wd = [], yr(t, dp), e = wd.length) {
		...
		return wd = Md = null,
		pd === 1 / 0 || vd === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[pd, vd], [gd, yd]]
	},
	t.geoCentroid = function (t) {
		Ad = Td = Nd = Sd = Ed = kd = Cd = Pd = zd = Rd = Ld = 0,
		yr(t, pp);
		var n = zd,
		e = Rd,
		r = Ld,
		i = n * n + e * e + r * r;
		return i < Id && (n = kd, e = Cd, r = Pd, Td < Fd && (n = Nd, e = Sd, r = Ed), (i = n * n + e * e + r * r) < Id) ? [NaN, NaN] : [Qd(e, n) * Vd, lr(r / op(i)) * Vd]
	},
	t.geoCircle = function () {
		function t() {
			var t = r.apply(this, arguments),
			u = i.apply(this, arguments) * $d,
			f = o.apply(this, arguments) * $d;
			return n = [],
			e = Jr(-t[0] * $d, -t[1] * $d, 0).invert,
			ri(a, u, f, 1),
			t = {
				type: "Polygon",
				coordinates: [n]
	...
	t.geoInterpolate = function (t, n) {
		...
		g = p ? function (t) {
			...
			i = e * l + n * d,
			o = e * u + n * c;
			return [Qd(i, r) * Vd, Qd(o, op(r * r + i * i)) * Vd]
		}
		 : function () {
			return [e * Vd, r * Vd]
		};
	...
	t.geoPath = function (t, n) {
		function e(t) {
			return t && ("function" == typeof o && i.pointRadius(+o.apply(this, arguments)), yr(t, r(i))),
			i.result()
		}
		var r,
		i,
	...
	t.geoAlbersUsa = function () {
		...
		t.translate = function (t) {
			...
			r = +t[0],
			u = +t[1];
			return i = f.translate(t).clipExtent([[r - .455 * e, u - .238 * e], [r + .455 * e, u + .238 * e]]).stream(l),
			o = c.translate([r - .307 * e, u + .201 * e]).clipExtent([[r - .425 * e + Fd, u + .12 * e + Fd], [r - .214 * e - Fd, u + .234 * e - Fd]]).stream(l),
			a = s.translate([r - .205 * e, u + .212 * e]).clipExtent([[r - .214 * e + Fd, u + .166 * e + Fd], [r - .115 * e - Fd, u + .234 * e - Fd]]).stream(l),
			n()
		},
	...
	t.pack = function () {
		function t(t) {
			return t.x = e / 2,
			t.y = r / 2,
			n ? t.eachBefore(Wo(n)).eachAfter(Zo(i, .5)).eachBefore(Qo(1)) : t.eachBefore(Wo($o)).eachAfter(Zo(Go, 1)).eachAfter(Zo(i, t.r / Math.min(e, r))).eachBefore(Qo(Math.min(e, r) / (2 * t.r))),
			t
		}
		var n = null,
		e = 1,
	...
	t.partition = function () {
		function t(t) {
			...
			t.eachBefore(function (t, n) {
				return function (e) {
					e.children && Ko(e, e.x0, t * (e.depth + 1) / n, e.x1, t * (e.depth + 2) / n);
					var i = e.x0,
					o = e.y0,
					a = e.x1 - r,
					u = e.y1 - r;
	...
	t.stratify = function () {
		function t(t) {
			...
			if (o.parent = pv, o.eachBefore(function (t) {
					t.depth = t.parent.depth + 1,
					--s
				}).eachBefore(zo), o.parent = null, s > 0)
		...
		function n(t) {
			...
			t.parent.A = function (t, n, e) {
				if (n) {
					...
					u && !ia(a) && (a.t = u, a.m += l - s),
					o && !ra(f) && (f.t = o, f.m += c - h, e = t)
				}
				return e
			}
			(t, r, t.parent.A || e[0])
	...
	t.treemap = function () {
		...
		function n(t) {
			...
			t.x1 = o,
			t.y1 = h,
			t.children && (n = a[t.depth + 1] = u(t) / 2, r += l(t) - n, i += f(t) - n, o -= c(t) - n, h -= s(t) - n, o < r && (r = o = (r + o) / 2), h < i && (i = h = (i + h) / 2), e(t, r, i, o, h))
		}
		var e = yv,
		r = !1,
		i = 1,
	...
	t.treemapSquarify = yv,
	t.treemapResquarify = _v,
	t.interpolate = ln,
	t.interpolateArray = an,
	t.interpolateBasis = Qt,
	t.interpolateBasisClosed = Jt,
	t.interpolateDate = un,
	t.interpolateNumber = fn,
	t.interpolateObject = cn,
	t.interpolateRound = hn,
	t.interpolateString = sn,
	t.interpolateTransformCss = ul,
	t.interpolateTransformSvg = fl,
	t.interpolateZoom = gn,
	t.interpolateRgb = tl,
	t.interpolateRgbBasis = nl,
	t.interpolateRgbBasisClosed = el,
	t.interpolateHsl = dl,
	t.interpolateHslLong = pl,
	...
	t.interpolateHcl = vl,
	t.interpolateHclLong = gl,
	t.interpolateCubehelix = yl,
	t.interpolateCubehelixLong = _l,
	...
	t.randomUniform = bv,
	t.randomNormal = mv,
	t.randomLogNormal = xv,
	t.randomBates = Mv,
	t.randomIrwinHall = wv,
	t.randomExponential = Av,
	t.scaleBand = va,
	...
	t.scaleSequential = rf,
	t.schemeCategory10 = Vg,
	t.schemeAccent = $g,
	t.schemeDark2 = Wg,
	t.schemePaired = Zg,
	t.schemePastel1 = Qg,
	...
	t.schemeSet2 = ty,
	t.schemeSet3 = ny,
	t.interpolateBrBG = ry,
	t.schemeBrBG = ey,
	t.interpolatePRGn = oy,
	t.schemePRGn = iy,
	t.interpolatePiYG = uy,
	t.schemePiYG = ay,
	t.interpolatePuOr = cy,
	t.schemePuOr = fy,
	t.interpolateRdBu = ly,
	t.schemeRdBu = sy,
	t.interpolateRdGy = dy,
	t.schemeRdGy = hy,
	t.interpolateRdYlBu = vy,
	t.schemeRdYlBu = py,
	t.interpolateRdYlGn = yy,
	t.schemeRdYlGn = gy,
	t.interpolateSpectral = by,
	t.schemeSpectral = _y,
	t.interpolateBuGn = xy,
	t.schemeBuGn = my,
	t.interpolateBuPu = My,
	t.schemeBuPu = wy,
	t.interpolateGnBu = Ty,
	t.schemeGnBu = Ay,
	t.interpolateOrRd = Sy,
	t.schemeOrRd = Ny,
	t.interpolatePuBuGn = ky,
	t.schemePuBuGn = Ey,
	t.interpolatePuBu = Py,
	t.schemePuBu = Cy,
	t.interpolatePuRd = Ry,
	t.schemePuRd = zy,
	t.interpolateRdPu = Dy,
	t.schemeRdPu = Ly,
	t.interpolateYlGnBu = qy,
	t.schemeYlGnBu = Uy,
	t.interpolateYlGn = Yy,
	t.schemeYlGn = Oy,
	t.interpolateYlOrBr = Fy,
	t.schemeYlOrBr = By,
	t.interpolateYlOrRd = jy,
	t.schemeYlOrRd = Iy,
	t.interpolateBlues = Xy,
	t.schemeBlues = Hy,
	t.interpolateGreens = Vy,
	t.schemeGreens = Gy,
	t.interpolateGreys = Wy,
	t.schemeGreys = $y,
	t.interpolatePurples = Qy,
	t.schemePurples = Zy,
	t.interpolateReds = Ky,
	t.schemeReds = Jy,
	t.interpolateOranges = n_,
	t.schemeOranges = t_,
	t.interpolateCubehelixDefault = e_,
	t.interpolateRainbow = function (t) {
		(t < 0 || t > 1) && (t -= Math.floor(t));
		var n = Math.abs(t - .5);
		return o_.h = 360 * t - 100,
		o_.s = 1.5 - 1.5 * n,
		o_.l = .8 - .9 * n,
		o_ + ""
	},
	t.interpolateWarm = r_,
	t.interpolateCool = i_,
	t.interpolateViridis = a_,
	t.interpolateMagma = u_,
	t.interpolateInferno = f_,
	t.interpolatePlasma = c_,
	t.create = function (t) {
	...
	t.arc = function () {
		function t() {
			...
			p = s_(d - h),
			v = d > h;
			if (f || (f = t = re()), l < s && (c = l, l = s, s = c), l > y_)
				if (p > m_ - y_)
					f.moveTo(l * h_(h), l * v_(h)), f.arc(0, 0, l, h, d, !v), s > y_ && (f.moveTo(s * h_(d), s * v_(d)), f.arc(0, 0, s, d, h, v));
				else {
					var g,
					y,
					_ = h,
					...
					if (T > y_) {
						var k = cf(T / s * v_(A)),
						C = cf(T / l * v_(A));
						(w -= 2 * k) > y_ ? (k *= v ? 1 : -1, m += k, x -= k) : (w = 0, m = x = (h + d) / 2),
						(M -= 2 * C) > y_ ? (C *= v ? 1 : -1, _ += C, b -= C) : (M = 0, _ = b = (h + d) / 2)
					}
					var P = l * h_(_),
					z = l * v_(_),
					R = s * h_(x),
		...
		return t.centroid = function () {
			...
			r = (+o.apply(this, arguments) + +a.apply(this, arguments)) / 2 - __ / 2;
			return [h_(r) * t, v_(r) * t]
		},
	...
	t.symbol = function () {
		function t() {
			var t;
			if (r || (r = t = re()), n.apply(this, arguments).draw(r, +e.apply(this, arguments)), t)
	...
	t.curveCardinalOpen = j_,
	t.curveCardinal = F_,
	t.curveCatmullRomClosed = X_,
	t.curveCatmullRomOpen = G_,
	t.curveCatmullRom = H_,
	...
	t.timeInterval = Ba,
	t.timeMillisecond = zv,
	t.timeMilliseconds = Rv,
	t.utcMillisecond = zv,
	t.utcMilliseconds = Rv,
	t.timeSecond = Uv,
	t.timeSeconds = qv,
	t.utcSecond = Uv,
	t.utcSeconds = qv,
	...
	t.utcYear = Cg,
	t.utcYears = zg,
	t.timeFormatDefaultLocale = Ku,
	t.timeFormatLocale = Ga,
	t.isoFormat = Og,
	t.isoParse = Yg,
	t.now = mn,
	t.timer = Mn,
	...
	t.interval = function (t, n, e) {
		var r = new wn,
		i = n;
		return null == n ? (r.restart(t, n, e), r) : (n = +n, e = null == e ? mn() : +e, r.restart(function o(a) {
				a += i,
				r.restart(o, i += n, e),
				t(a)
			}, n, e), r)
	...
	t.active = function (t, n) {
		...
		if (i) {
			n = null == n ? null : n + "";
			for (r in i)
				if ((e = i[r]).state > Pl && e.name === n)
					return new Un([[t]], ch, n, +r)
		}
		return null
	},
	t.interrupt = Rn,
	t.voronoi = function () {
		function t(t) {
			return new qc(t.map(function (r, i) {
					var o = [Math.round(n(r, i, t) / tb) * tb, Math.round(e(r, i, t) / tb) * tb];
					return o.index = i,
					o.data = r,
					o
				}), r)
	...
	t.zoom = function () {
		...
		function r(t, n, e) {
			var r = n[0] - e[0] * t.k,
			i = n[1] - e[1] * t.k;
			return r === t.x && i === t.y ? t : new Yc(t.k, r, i)
		}
		function i(t) {
			...
			t.on("start.zoom", function () {
				...
				return function (t) {
					if (1 === t)
						...
						var n = l(t),
						e = f / n[2];
						t = new Yc(e, u[0] - n[0] * e, u[1] - n[1] * e)
					}
					r.zoom(null, t)
				}
			})
		...
		function s() {
			if (g.apply(this, arguments)) {
				...
				Ic(),
				M > 0 ? ct(this).transition().duration(M).call(o, c, a) : ct(this).call(n.transform, c)
			}
		}
		function l() {
			if (g.apply(this, arguments)) {
		...
		function h() {
			...
			s = c.length;
			for (Ic(), p && (p = clearTimeout(p)), n = 0; n < s; ++n)
		...
		function d() {
			...
			o = i.length;
			for (Fc(), v && clearTimeout(v), v = setTimeout(function () {
						v = null
					}, E), n = 0; n < o; ++n)
		...
		n.translateTo = function (t, e, r) {
			n.transform(t, function () {
				...
				n = this.__zoom,
				o = i(t);
				return _(eb.translate(o[0], o[1]).scale(n.k).translate("function" == typeof e ? -e.apply(this, arguments) : -e, "function" == typeof r ? -r.apply(this, arguments) : -r), t, w)
			})
		},
		u.prototype = {
			start: function () {
				return 1 == ++this.active && (this.index = T.push(this) - 1, this.emit("start")),
				this
			},
			zoom: function (t, n) {
				...
				return 0 == --this.active && (T.splice(this.index, 1), this.index = -1, this.emit("end")),
				this
			},
			emit: function (t) {
				ot(new function (t, n, e) {
